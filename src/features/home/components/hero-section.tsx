    ...
    <section className="grid grid-cols-[minmax(20.625rem,.9fr)_minmax(27.5rem,1.1fr)] items-start gap-[clamp(2.75rem,7vw,6rem)] max-lg:grid-cols-1">
      ...
      <div>
        ...
        <p className="text-muted mt-7 max-w-[36rem] text-[1.0625rem] leading-[1.7]">
          Software engineer with 5+ years turning complex product ideas into fast, maintainable apps
          — React and Next.js on the web, React Native and Ionic on mobile, with Node.js on the back
          end when delivery needs it.
        </p>
