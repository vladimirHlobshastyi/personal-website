export const SERVICE_OFFERS = [
  {
    ...
    text: 'React and Next.js systems built to stay clear, maintainable, and scalable in real product teams.',
  },
  {
    title: 'Web and mobile delivery',
    text: 'Product delivery across web, iOS, and Android with React, Next.js, React Native, and Ionic.',
  },
  {
