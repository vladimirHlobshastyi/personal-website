...
import {
  RETRO_LINES_FEATURES,
  RETRO_LINES_PRIVACY_POLICY_URL,
} from '../_constants/retro-lines.constants';
    ...
    <main className="grid gap-5">
      ...
      <section className="grid gap-5 lg:grid-cols-[1.1fr_.9fr]">
        ...
        <article className="border-line bg-surface border p-8 max-sm:p-6">
          ...
          <ul className="grid gap-3">
            {RETRO_LINES_FEATURES.map((feature) => (
      ...
      <section className="grid gap-5 lg:grid-cols-[1fr_.82fr]">
        <article className="border-line bg-surface border p-8 max-sm:p-6">
          ...
          <Link
            href={RETRO_LINES_PRIVACY_POLICY_URL}
            target="_blank"
